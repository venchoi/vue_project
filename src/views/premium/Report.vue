...
<script>
  ...
  export default {
    ...
    watch: {
      listData() {
        const vm = this;
        vm.data = vm.listData.report_list;
        vm.data.unshift(vm.listData.report);
        vm.content = vm.listData.report;
        if (!vm.newsCache[vm.listData.report.id]) {
          vm.newsCache[vm.listData.report.id] = vm.content;
        }
      },
    },
    methods: {
