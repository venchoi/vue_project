<template>
  <div id="register">
      <popup ref="popup" :isShow="isShow" v-on:click-popupBg="hide" :size=300>
        <div class="title">注 册 <div class="close" @click="hide"><icon-font iconName="close" size="14px"></icon-font></div></div>
        <div class="content">
          <div class="content-inner">
            <ycj-form :postData="formData" :api="registerApi">
              ...
              <div class="agree-register">
                <input type="checkbox" id="agree" value="true" v-model="agreeRegister">
                <label for="agree">我已阅读并同意 <router-link :to="'/stock/'+300048">《用户注册协议》</router-link></label>
              </div>
              <form-button :binding="formData">注册</form-button>
