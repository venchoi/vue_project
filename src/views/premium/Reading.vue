...
<script>
  ...
  export default {
    ...
    watch: {
      listData() {
        const vm = this;
        vm.data = vm.listData.early_read_list;
        vm.data.unshift(vm.listData.early_read);
        vm.content = vm.listData.early_read;
        if (!vm.newsCache[vm.listData.early_read.id]) {
          vm.newsCache[vm.listData.early_read.id] = vm.content;
        }
      },
    },
    methods: {
